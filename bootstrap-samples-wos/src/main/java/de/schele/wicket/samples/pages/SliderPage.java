...
public class SliderPage extends BasePage {
    ...
    public SliderPage(PageParameters parameters) {
        ...
        }).setTooltipSplit(true));

        Form<Void> reversedForm = new Form<Void>("reversedForm");
        add(reversedForm);
        reversedForm.add(newSlider("reversedSlider", reversedSliderModel, 0L, 100000L, 10L).setReversed(true));
    }
    ...
    private NumericBootstrapSlider<Long> newSlider(String markupId, Model<Long> longSliderModel, Long min, Long max, Long step) {
        NumericBootstrapSlider slider= new NumericBootstrapSlider<Long>(markupId, longSliderModel);
